...
export const kanbanPreset: ThemePreset = {
  id: "kanban", name: "Kanban", ...base,
  tokens: {
    container: { background: "#F8F9FA", border: "#DEE2E6", borderRadius: 14, padding: 40 },
    node: {
    ...
    typography: { nodeLabel: { fontSize: 11, color: "#343A40", fontWeight: "500" } },
  },
}
...
export const kanbanDarkPreset: ThemePreset = {
  id: "kanban", name: "Kanban", ...base,
  tokens: {
    container: { background: "#1A1A2E", border: "#16213E", borderRadius: 14, padding: 40 },
    node: {
    ...
    typography: { nodeLabel: { fontSize: 11, color: "#E0E0E0", fontWeight: "500" } },
  },
}
