...
export const networkPreset: ThemePreset = {
  id: "network", name: "Network", ...base,
  tokens: {
    container: { background: "#FAFAFA", border: "#E5E7EB", borderRadius: 12, padding: 44 },
    node: {
    ...
    typography: { nodeLabel: { fontSize: 11, color: "#374151", fontWeight: "600" } },
  },
}
...
export const networkDarkPreset: ThemePreset = {
  id: "network", name: "Network", ...base,
  tokens: {
    container: { background: "#09090B", border: "#27272A", borderRadius: 12, padding: 44 },
    node: {
    ...
    typography: { nodeLabel: { fontSize: 11, color: "#D4D4D8", fontWeight: "600" } },
  },
}
